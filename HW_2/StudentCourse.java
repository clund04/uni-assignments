...
public class StudentCourse {
    ...
    private boolean checkGradeValidity(final int gradeNum) {
        ...
        if ((gradeNum == (int) ConstantValues.GRADE_ACCEPTED ||
            gradeNum == (int) ConstantValues.GRADE_FAILED)) {
            return true;
        }
        return false;
    ...
    public boolean isPassed() {
        if (gradeNum == ConstantValues.MIN_GRADE || gradeNum == (int) ConstantValues.GRADE_FAILED) {
            return false;
        }
        return true;
    }
